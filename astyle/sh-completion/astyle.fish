...
complete -c astyle -l pad-negation -d 'Insert space padding after negations'
complete -c astyle -l pad-include -d 'Insert space padding after include directives'
...
complete -c astyle -l pad-brackets -d 'Insert space padding around square brackets on both the outside and the inside'
complete -c astyle -l pad-brackets-in -d 'Insert space padding around square brackets on the inside only'
complete -c astyle -l pad-brackets-out -d 'Insert space padding around square brackets on the outside only'
